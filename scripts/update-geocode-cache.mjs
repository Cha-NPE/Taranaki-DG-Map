...
// Taranaki region — New Plymouth down through South Taranaki (Hawera,
// Patea), north to the Mokau/Awakino border area. Keep this in sync with
// NZ_TARGET_BBOX in index.html.
const NZ_TARGET_BBOX = { west: 173.75, south: -39.75, east: 174.95, north: -38.65 };
